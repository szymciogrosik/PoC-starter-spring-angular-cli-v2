...
insert into "User" ("id", "username", "password", "firstName", "lastName", "email", "accountCreation", "lastModification") values ( 1, 'admin', '$2a$10$O6p/ftbC7LbrhpZsIFk9SegNDSk62BXq2ctKF9kqMVxCGYDwQt8n6', 'Andrzej', 'Abacki', 'a.abacki@gmail.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
insert into "User" ("id", "username", "password", "firstName", "lastName", "email", "accountCreation", "lastModification") values ( 2, 'user', '$2a$10$O6p/ftbC7LbrhpZsIFk9SegNDSk62BXq2ctKF9kqMVxCGYDwQt8n6', 'Bogdan', 'Babacki', 'b.babackii@gmail.com', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
